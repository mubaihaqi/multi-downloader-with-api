                ...
                <>
                  ...
                  <div className="space-y-3">
                    {result.media.map((item, index) => (
                      <button
                        ...
                        onClick={() =>
                          handleSmartDownload(
                            item.url,
                            `pinterest_${
                              item.extension === "mp4" ? "video" : "image"
                            }_${item.quality || `item${index + 1}`}.${
                              item.extension
                            }`
                          )
                        }
                      ...
                      >
                        {`Unduh ${
                          item.extension === "mp4" ? "Video" : "Gambar"
                        } (${item.quality || `Tipe ${index + 1}`}${
                          item.extension !== "mp4" ? "." + item.extension : ""
                        })`}
                        {item.formattedSize && (
